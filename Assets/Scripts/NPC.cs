...
//     [Tooltip("Dialogue typing sound configuration used whenever this NPC speaks.")]
//     [SerializeField] private DialogueVoiceData dialogueVoice;

//     /// <summary>The world-space point DialogueUI should position the bubble above for this NPC.</summary>
//     public Transform DialogueAnchor => dialogueAnchor != null ? dialogueAnchor : transform;
//     public DialogueVoiceData DialogueVoice => dialogueVoice;
...
//              "own transform if left empty.")]
//     [SerializeField] private Transform dialogueAnchor;
//     [Tooltip("Voice/typing-sound configuration used whenever this NPC is the speaker in dialogue.")]
//     [SerializeField] private DialogueVoiceData voiceData;

//     /// <summary>The world-space point DialogueUI should position the bubble above for this NPC.</summary>
//     public Transform DialogueAnchor => dialogueAnchor != null ? dialogueAnchor : transform;

//     /// <summary>Voice/typing-sound configuration for this NPC, read by DialogueManager when it speaks.</summary>
//     public DialogueVoiceData VoiceData => voiceData;
...
//     /// <summary>
//     /// Jumps this NPC's dialogue sequence DIRECTLY to the given value (unlike AdvanceSequence's +1).
//     /// Called by DialogueManager when a node's advanceSequenceByPrimaryTask fires.
//     /// </summary>
...
public class NPC : MonoBehaviour
{
    ...
    public int CurrentSequence
    {
        get
        {
            ...
            return gameData.GetNPCSequence(npcID);
        }
    }
    ...
    private void Awake()
    {
        ...
        if (gameData == null)
        {
            Debug.LogError($"NPC '{name}' has no GameData assigned.");
        }
    }
    ...
    public void AdvanceSequence()
    {
        ...
        gameData.SetNPCSequence(npcID, CurrentSequence + 1);
    }
    ...
    public void SetSequence(int sequence)
    {
        ...
        gameData.SetNPCSequence(npcID, sequence);
    }
